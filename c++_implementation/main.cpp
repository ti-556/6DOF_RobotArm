...
#include "includes/IKcalculation.hpp"
...
std::array<double, 4> wristeffector = wristcalculation(endeffector);

std::array<double, 2> angle1 = angle1calculation(wristeffector);
std::array<double, 4> angle2 = angle2calculation(wristeffector, angle1);
std::array<double, 4> angle3 = angle3calculation(wristeffector, angle2, angle1);
